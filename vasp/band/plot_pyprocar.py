...
pyprocar.bandsplot(cmap='OrRd',mode = 'parametric', code = 'vasp', elimit=[-1,7], fermi=4.8046, show=False, atoms=[0,1,2], orbitals=[i for i in range(4,9)],savefig='./NbO_fatband_p7m1_Nb_d.pdf',dirname='./')
#pyprocar.dosplot(code='vasp',dirname="./",savefig="./NbO-nosoc-relax2-dos.pdf",mode='plain',elimit=[-10, 10],fermi=0.2922,orientation='horizontal')
#pyprocar.bandsplot(mode = 'plain', code = 'vasp', elimit=[-2,2], fermi=4.8046, show=False, savefig='./NbO_band_p2m2.pdf',dirname='./')
