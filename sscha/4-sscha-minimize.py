...
# Edit these
dyn = CC.Phonons.Phonons("LCO.dyn", nqirr=6)
dyn.Symmetrize()
dyn.ForcePositiveDefinite()
ensemble = sscha.Ensemble.Ensemble(dyn, T0=150, supercell=dyn.GetSupercell())
ensemble.load("data_ensemble_manual", population=1, N=250)

# Lets reset other calculation if you run this cell multiple times
ensemble.update_weights(dyn, 150) # Restore the original density matrix at T = 100 K
...
# minimizer.dyn.save_qe_xml("LCO.dyn", "dyn_pop3_")
